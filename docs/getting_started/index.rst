...
This means that you can both run it quickly locally to test a workflow,
...
We recommend that you start by setting up the (:ref:`getting_started-example-workflow`)
